                ...
                <div class="col-md-9">
                  ...
                  <div class="col-md-12">
                    <form class="form-group row">
                      ...
                      <button
                        type="submit"
                        v-on:click="updateSenior1Progress1()"
                ...
                <div class="col-md-9">
                  ...
                  <div class="col-md-12">
                    <form class="form-group row">
                      ...
                      <button
                        type="submit"
                        v-on:click="updateSenior1Progress2()"
                        class="btn btn-primary mb-2 float-right"
                      >Update</button>
                    </form>
                  </div>
                ...
                <div class="col-md-9">
                  ...
                  <div class="col-md-12">
                    <form class="form-group row">
                      ...
                      <button
                        type="submit"
                        v-on:click="updateSenior1FinalPresent()"
                        class="btn btn-primary mb-2 float-right"
                      >Update</button>
                    </form>
                  </div>
                ...
                <div class="col-md-9">
                  ...
                  <div class="col-md-12">
                    <form class="form-group row">
                      ...
                      <button
                        type="submit"
                        v-on:click="updateSenior1FinalDocument()"
                        class="btn btn-primary mb-2 float-right"
                      >Update</button>
                    </form>
                  </div>
                ...
                <div class="col-md-9">
                  ...
                  <div class="col-md-12">
                    <form class="form-group row">
                      ...
                      <button
                        type="submit"
                        v-on:click="updateSenior2Progress1()"
                        class="btn btn-primary mb-2 float-right"
                      >Update</button>
                    </form>
                  </div>
                ...
                <div class="col-md-9">
                  ...
                  <div class="col-md-12">
                    <form class="form-group row">
                      ...
                      <button
                        type="submit"
                        v-on:click="updateSenior2Progress2()"
                        class="btn btn-primary mb-2 float-right"
                      >Update</button>
                    </form>
                  </div>
                ...
                <div class="col-md-9">
                  ...
                  <div class="col-md-12">
                    <form class="form-group row">
                      ...
                      <button
                        type="submit"
                        v-on:click="updateSenior2FinalPresent()"
                        class="btn btn-primary mb-2 float-right"
                      >Update</button>
                    </form>
                  </div>
                ...
                <div class="col-md-9">
                  ...
                  <div class="col-md-12">
                    <form class="form-group row">
                      ...
                      <button
                        type="submit"
                        v-on:click="updateSenior2FinalDocument()"
                        class="btn btn-primary mb-2 float-right"
                      >Update</button>
                    </form>
                  </div>
